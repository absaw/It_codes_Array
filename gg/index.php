...
<body>
          ...
          <div class="container-fluid">
            <div class="navbar-header">
              <div class="navbar-brand">
                <a href="index.html"><h1>Array !</h1></a>
              </div>
            </div>
            <div class="menu">
              ...
              <!--<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.6s">
                <form class="form-inline">
                  <div class="form-group">
                    <a type="livedemo" name="purchase" class="btn btn-primary btn-lg" href="signup.php" required="required">Log In</a>
                  </div>
                  <div class="form-group">
  ...
  <!--start footer-->
    ...
    <div class="sub-footer" style="margin-left:0px;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
